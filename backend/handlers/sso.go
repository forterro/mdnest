...
// default behavior of only redirecting to frontendURL. autoProvisionUsers opts
// into creating a least-privilege collaborator for an unknown but
// IdP-authenticated email on first login.
